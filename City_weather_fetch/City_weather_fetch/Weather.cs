...
namespace City_weather_fetch
{
	public class Weather : City_weather
	{
        ...
        public static string currentCityCondition;
        public Weather()
        {
            city_name = "";
            url = "";
        ...
        public  int get_weather_of_city()
        {
             ...
             try
             {
               ...
               currentCityCondition = nodeList2.Item(0).SelectSingleNode("condition").Attributes["data"].InnerText;
               //Cookie k = new Cookie();
               //k.Value["cur"] = currentCityCondition;
               //k.Expired = DateTime.Now.AddDays(2);
